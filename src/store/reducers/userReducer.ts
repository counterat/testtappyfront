...
export const {setBoosters, setTickets, changeTicket, setIsHammer, setTap, setPhotoUrl, setUsername, setUsersBirds, setInviteLink , setLimitenergy, setTappyCoin, setCompletedtasks, changeSquad, setHammers, setSign, setLimitExp, changeEnergy, setUserId, changeExp, changeLevel, changeCoin , setLevel, setUser} =
	userSlice.actions;
